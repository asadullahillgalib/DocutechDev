...
import io.naztech.nuxeoclient.service.ScannedItextNmbsInvoiceService;
import io.naztech.nuxeoclient.service.ScannedNmbsInvoiceUploadService;
import lombok.extern.slf4j.Slf4j;

@Controller
@Slf4j
public class ScannedNmbsInvoiceUploadController {
	@Autowired
	private ScannedItextNmbsInvoiceService servNmbs;
	
	@Autowired
	private ScannedNmbsInvoiceUploadService service;
	...
	public void uploadNmbhDocument() throws IOException {
		...
		for (File pdf : pdflist) {
			...
			servNmbs.uploadDocument(Arrays.asList(pdf), true);
